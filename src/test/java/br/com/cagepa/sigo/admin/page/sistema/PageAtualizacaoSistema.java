...
public class PageAtualizacaoSistema extends PageObjectGeneric<PageAtualizacaoSistema> {

	public PageAtualizacaoSistema() {
	...
	public void excluirSistemaComSucesso(String sigla, String nome){
